...
* The Committee welcomed [Matt Davis](mailto:matt.davis@intersectmbo.org) and Alex Kingdon from Intersect as Observers for the meeting<br>
* The Committee reviewed the proposed initial settings for the Governance parameters.\
  ...
  \
  All other recommendations from the Governance advisory group were accepted. These recommendations will be applied on SanchoNet following the next respin and will be incorporated into the Conway genesis file.<br>
