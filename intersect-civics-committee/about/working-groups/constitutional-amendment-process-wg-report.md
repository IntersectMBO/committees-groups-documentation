# Constitutional Amendment Process WG Report

## How the Cardano Community Built a Process for Changing Its Own Constitution

_A look at six months of work that brought the Constitutional Amendment Process from a blank page to a process ready for public testing._
...
But almost immediately, a practical question surfaced: _what happens when we need to change it?_
...
1. A document defining _what_ the process must achieve (the requirements)
2. A document defining _how_ the process would work (the design)
...
Another perspective encouraged the group to take a step back. Before deciding on any tool or platform, agree first on the _tests_ the process must pass. Three stood out in particular: a legitimacy test (will people accept it as fair?), an accessibility test (can anyone participate?), and a traceability test (can every decision be followed back to its source?).
...
Before designing anything, the group spent six weeks doing something that might sound boring but turned out to be the most important work of the entire project: writing down exactly what the amendment process _must_ achieve.
...
1. Every amendment must clearly state _why_ a change is needed, _what_ text is being changed, and _what effect_ the change is expected to have
...
The full design is documented in the [Phase 2 Deliverables](https://docs.google.com/document/d/10F2CDclL3BkD0mmVDbJL6M-BolFngwyoh498MBG6krs/edit?usp=sharing) _(work in progress)_.
...
The full system is documented in the [CAP Tagging System](https://docs.google.com/document/d/1-_zCl-9dM6oFIyLnTCjYVZCdphyQiunvIOgkWQCFMF0/edit?usp=sharing).

#### The Tool Itself

The **CAP Portal** is the website where all of this comes together. It gives users:

* A guided form (the "Amendment Wizard") that walks you through writing a proposal step by step
* A board showing all active proposals and which stage they're at
* A side-by-side viewer that shows exactly what the Constitution would look like with the proposed changes applied
* A way to download proposals
* A built-in bug reporting system for the tool itself

Behind the scenes, everything is stored permanently on a public repository, meaning the full history of every proposal, every comment, and every revision is publicly available forever and can be independently verified by anyone. All proposals are automatically published under a Creative Commons license (CC-BY-4.0), so the content belongs to the community.
...
A few things are still genuinely open, and the working group has been honest about that. The question of exactly _who_ submits the final on-chain governance action at the end of the process hasn't been fully resolved. Multilingual support is on the roadmap but not yet built. And some of the longer-term governance mechanics, like exactly how the process will be formally reviewed and updated over time, are intentionally left to be defined once there's real-world experience to draw on.
...
| Phase 2 Deliverables Document _(work in progress)_ | [View](https://docs.google.com/document/d/10F2CDclL3BkD0mmVDbJL6M-BolFngwyoh498MBG6krs/edit?usp=sharing) |
...
| Simple Framework Document                          | [View](https://docs.google.com/document/d/1yfUjQYlRdl6PhyOjRn7tRgCJ6K7FzosO4NpelAcy6Y4/edit?usp=sharing) |
| Requirements-to-CAP Matrix                         | [View](https://docs.google.com/document/d/1dHVsKC0HvbJlK1iihTW3clhInq8QtpBCLFlUQ0WCz7o/edit?usp=sharing) |
| WG Meeting Transcripts (all)                       | [View folder](https://drive.google.com/drive/folders/1oILReUq36yM3J-eYABr_9dY9R3l3heOJ?usp=sharing)      |
| Workshop Materials (Day Zero & Berlin)             | [View folder](https://drive.google.com/drive/folders/1j_fmp8fShyeL10LnPh0L8rkjYgk6q4Sh?usp=sharing)      |
